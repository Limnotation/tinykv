...
// `local` has one implication: Only the `msg_type` matters.
...
type Message struct {
	...
	// index can be of many uses:
	//  1. When message type is MsgAppend or MsgAppendResponse, this index can contain
	//     the commit index of the message sender.
